    ...
    <center><table style="width: 900px; height: 56px;" border="1">
      ...
      <td style="width: 200.067px;"><center>DESTINO</center></td>
        ...
        <tr style="height: 30px;">
            ...
            <td   contentEditable="true" class="productocompra1"></td>
        <td style="width: 307.533px;" class="bodegacompra1"  ><center></center></td>
        <td style="width: 200.067px;" class="viajescompra1"contentEditable="true"><center></center></td>
        ...
        <td style="width: 307.533px;" class="valorunitariocompra1" contentEditable="true" ><center></center></td>
        <td style="width: 200.067px;" class="valortotalcompra1" ><center></center></td>
